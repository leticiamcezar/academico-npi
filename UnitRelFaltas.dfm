object FormRelFaltas: TFormRelFaltas
  Left = 191
  Top = 117
  ...
  object ADOQueryRelFaltas: TADOQuery
  ...
  object RelFaltas: TRvProject
    Left = 160
    Top = 8
  end
  object RvDataSetRelFaltas: TRvDataSetConnection
    RuntimeVisibility = rtDeveloper
    DataSet = ADOQueryRelFaltas
    Left = 192
    Top = 8
  end
end
